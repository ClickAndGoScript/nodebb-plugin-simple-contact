{{{ if error }}}
<div style="color:#c00; font-size:13px; text-align:center;">[[simple-contact:error.internal]]</div>
{{{ end }}}
{{{ if !error }}}
{{{ if !comments.length }}}
<div style="color:#aaa; font-size:13px; text-align:center;">[[simple-contact:admin.no-comments]]</div>
{{{ end }}}
{{{ each comments }}}
